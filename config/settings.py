...
# NEW: Perplexity API for intelligent pros/cons/suggestions
PERPLEXITY_API_KEY = os.getenv('PERPLEXITY_API_KEY')  # Get from environment variable
PERPLEXITY_MODEL = "sonar"  # Perplexity's model
...
AMENITY_SEARCH_RADIUS = 3000  # 3km
